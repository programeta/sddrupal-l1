...
8. En greenfield, instalar Drupal CMS sin fijar versión para obtener la última versión estable disponible
9. En DDEV, derivar `name` del nombre de la carpeta actual del proyecto
10. No modificar la lógica de negocio
11. No romper la compatibilidad heredada
