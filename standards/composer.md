...
- Greenfield: partir de Drupal CMS con `composer create-project drupal/cms` sin fijar una versión concreta para obtener la última versión estable, ejecutado dentro de DDEV tras levantar el entorno
- Greenfield: la normalización final de Composer la define `playbooks/greenfield.md`, no el template base
